            ...
            <nav class="header__nav js-header__nav" id="header-nav" role="navigation" aria-label="Main">
                <div class="header__nav-inner">
                    ...
                    <ul class="header__list">
                        ...
                        <li class="header__item"><a href="#0" class="header__link">Resources</a></li>
                        ...
                        <li class="header__item">
                            <a href="#0" class="header__link header__link--icon">
                                <svg class="icon" viewBox="0 0 16 16">
                                    <title>Cart</title>
                                    <g fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1" stroke="currentColor">
...
.header__nav {
  ...
  font-size: 1.5em; // controls the font-size of all elements (sm)
  display: none;
...
@include breakpoint(md) {
  .header__nav {
    ...
    font-size: 1em; // controls the font-size of all elements (md)
